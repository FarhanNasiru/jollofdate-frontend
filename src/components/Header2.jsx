...
function Header() {
  ...
  return (
    <div>
      <div>
        <header className="flex justify-between items-center fixed top-0 w-11/12 m-auto bg-white rounded-full py-4 px-10 left-1/2 transform -translate-x-1/2 z-50 ">
          <div className="logo">
            <img
              src="/Jellofdate/image 5 (1).jpg"
          ...
          <div className="lg:hidden">
            <button onClick={toggleSidebar} className=" focus:outline">
              {isSidebarOpen ? (
                <img src="/Jellofdate/close-icon.png" alt="" />
              ) : (
                <img src="/Jellofdate/menu.png" alt="" />
              )}
            </button>
          </div>
