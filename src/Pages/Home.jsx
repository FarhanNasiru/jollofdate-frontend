...
function Home() {
  return (
    <main className=" bg-white justify-center font-HvDTrial">
      ...
      <section
        id="home"
        className="pl-8 pr-8 justify-center bg-center bg-no-repeat items-center w-full lg:pt-64 lg:pb-9 bg-[url('/Jellofdate/Home-bg.png')] h-auto"
      >
        <h1 className="  text-wrap text-white text-7xl md:text-7xl  font-medium md:font-semibold text-center pt-32 pb-14 h-auto">
        ...
        <div className=" flex justify-center pt-12 flex-wrap pb-16">
          ...
          >
            <img
              src="/Jellofdate/Googleplay-whitesvg.svg"
              alt="Google Play"
          ...
          >
            <img
              src="/Jellofdate/Applestore-white.png"
              alt="App Store"
        ...
        <div className=" justify-center ">
          <a href="#footer">
            <img
              src="/Jellofdate/Home-arrow.png"
              alt=""
              className=" hidden md:flex justify-center m-auto md:pb-32"
            />
          </a>
        </div>
      </section>
