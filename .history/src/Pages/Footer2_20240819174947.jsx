...
function Footer() {
  return (
    <footer id="footer" className=" px-20 pt-44 bg-featuresY text-white mb-5">
      <div className="">
        <div className="flex flex-wrap lg:space-x-8 mb-20 lg:justify-between space-y-8 lg:space-y-0">
          <div className="">
            ...
            <div className="flex space-x-7 pt-7">
              <a href="" id="">
                <img src="/Jellofdate/facebook.png" alt="" />
              </a>
              <a href="" id="">
                <img src="/Jellofdate/ig.png" alt="" className="" />
              </a>
              <a href="" id="">
                <img src="/Jellofdate/twitter.png" alt="" />
              </a>
            </div>
          </div>
          ...
          <div className=" md:pt-6 lg:p-6">
            ...
            <div className="space-y-3">
              <div className="flex gap-3 ">
                <img
                  src="/Jellofdate/ic_baseline-phone.svg"
                  alt=""
                  className="text-xl"
                />
                +1 656 774 7848
              ...
              <div className="flex gap-3 text-xl">
                <img src="/Jellofdate/mdi_web.svg" alt="" />
                <a href="">jollofdate.com</a>
              </div>
              <div className="flex gap-3 text-xl">
                <img src="/Jellofdate/bx_support.svg" alt="" />
                <a href="">support@jollofdatecom</a>
              </div>
            </div>
          </div>
            ...
            <div>
              <div className="flex items-center w-72 mx-auto mt-10">
                ...
                <button className=" text-white rounded-r-md ">
                  <img src="/Jellofdate/email.png" alt="" />
                </button>
              </div>
            </div>
          </div>
