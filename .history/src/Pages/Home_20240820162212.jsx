...
function Home() {
  return (
    <main className=" bg-white justify-center font-HvDTrial">
      ...
      <section
        id="home"
        className="pl-8 pr-8 justify-center bg-center bg-no-repeat items-center w-full lg:pt-64 lg:pb-9 bg-[url('/Images/Home-bg.png')] h-auto"
      >
        ...
        <p className=" text-2xl px-6 text-center text-white font-normal md:text-3xl mb-14">
