...
function Home() {
  return (
    <main className=" bg-white justify-center font-HvDTrial">
      ...
      <section
        id="home"
        className="pl-8 pr-8 justify-center bg-center bg-no-repeat items-center w-full lg:pt-96 lg:pb-9 bg-[url('/Images/Home-bg.png')] "
      >
        <h1 className="  text-wrap text-white text-7xl md:text-7xl  font-medium md:font-semibold text-center pt-auto pb-6 h-auto">
