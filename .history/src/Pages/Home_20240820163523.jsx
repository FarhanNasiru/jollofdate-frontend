...
function Home() {
  return (
    <main className=" bg-white justify-center font-HvDTrial">
      ...
      <section
        id="home"
        className="pl-8 pr-8 justify-center bg-center bg-no-repeat items-center w-full lg:pt-72 lg:pb-9 bg-[url('/Images/Home-bg.png')] h-auto"
      >
        ...
        <div className=" justify-center ">
          <a href="#footer">
            <img
              ...
              alt=""
              className=" sm:hidden md:flex lg:flex xl:flex justify-center m-auto md:pb-20"
            />
          </a>
        </div>
      </section>
