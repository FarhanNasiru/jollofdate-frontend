...
function Testimonials() {
  ...
  return (
    <section id="testimonials" className="p-8 pt-24">
      <div>
        <h2 className="text-5xl font-bold text-center p-2">Testimonials</h2>
        <div className="flex justify-center pb-5 md:pb-6">
          <img src="/Jellofdate/love-logo.png" alt="Love Logo" />
        </div>
        <h3 className="text-center text-lg">
          Read what our existing users have to say
        </h3>
      </div>
      <div className="text-center pt-9 pb-16 text-black">
        <Carousel autoplay>
