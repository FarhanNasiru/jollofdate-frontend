  ...
  return (
    <div>
      <section id="about-us" className="pt-16 md:pt-24">
        ...
        <div className="flex flex-wrap text-center flex-col space-y-12 pb-12 lg:pb-28 justify-center space-x-20 md:space-x-48 px-9 ">
          <div className="flex md:space-x-0 mt-12 text-center">
            <div>
