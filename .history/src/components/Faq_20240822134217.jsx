...
function Faq() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: `Your safety is our top priority on Jollof Date. If someone makes you feel unsafe or uncomfortable, please don't hesitate to report them. To report a user:
