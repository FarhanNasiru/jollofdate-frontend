      ...
      <section id="about-us" className="pt-16 md:pt-24">
        <div className="px-4 md:px-24">
          ...
          <div className="flex justify-center pb-4">
            <img src="/Jellofdate/love-logo.png" alt="" className="md:14" />
          </div>
        ...
        <div className="flex flex-wrap text-center space-y-8 pb-12 lg:pb-28 justify-between px-32">
          <div className="flex space-x-3 mt-8">
            <div>
              <img src="/Jellofdate/person.png" alt="" className=" " />
            </div>
            <div className="">
          ...
          <div className="flex space-x-3">
            <div>
              <img src="/Jellofdate/people.png" alt="" className="" />
            </div>
            <div className="">
          ...
          <div className="flex space-x-3">
            <div>
              <img src="/Jellofdate/world-o.png" alt="" className="" />
            </div>
            <div className="">
          ...
          <div className="flex space-x-3">
            <div>
              <img src="/Jellofdate/Star2.png" alt="" className="" />
            </div>
            <div className="">
              <h1 className="font-bold text-4xl">100</h1>
