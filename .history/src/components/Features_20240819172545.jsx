function Features() {
  return (
    <div>
      <section
        id="features"
        className=" md:p-8 pt-16 md:pt-24 mb-20 md:mb-40 bg-featuresY h-full w-full md:h-custom16"
      >
        <div className="">
          ...
          <div className="flex flex-col md:flex-row h-full space-y-4 md:space-y-0 md:space-x-9 pl-0 md:pl-8 pr-0 md:pr-8 mt-8 w-full">
            ...
            <div className="bg-white text-center border rounded-3xl md:flex hidden">
              <a href="">
                <img src="/Jellofdate/Phone2.png" alt="" className="w-full" />
              </a>
            </div>
            <div className="bg-white text-center border rounded-3xl md:flex hidden">
              <a href="">
                <img src="/Jellofdate/Phone3.png" alt="" className="w-full" />
              </a>
            </div>
          </div>
        </div>
