...
function Faq() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: `
      Your safety is our top priority on Jollof Date. If someone makes you feel unsafe or uncomfortable, please don't hesitate to report them. To report a user:``<br />1. Open the profile on matches to view chat
      <br />2. Click the three-dot menu on the top right
      <br />3. Click on either report or block
