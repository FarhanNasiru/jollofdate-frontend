  ...
  return (
    <div>
      <section id="about-us" className="pt-16 md:pt-24">
        ...
        <div className="flex flex-wrap text-center flex-col md:flex-row space-y-12 pb-12 lg:pb-28 justify-center space-x-20 md:space-x-48 px-9 ">
          <div className="flex mt-12 m-auto space-x-3 text-center">
            <div>
