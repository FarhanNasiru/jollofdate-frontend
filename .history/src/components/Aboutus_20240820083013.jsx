  ...
  return (
    <div>
      <section id="about-us" className="pt-16 md:pt-24">
        ...
        {/* <div className="flex flex-wrap text-center flex-col md:flex-row space-y-12 pb-12 lg:pb-28 justify-center space-x-20 md:space-x-48 px-14 ">
          <div className="flex mt-12 m-auto text-center">
            <div>
          ...
          <div className="flex space-x-3">
            ...
            <div className="">
              <h1 className="font-bold text-4xl justify-start m-auto flex">
                100
              </h1>
        ...
        <div className="flex flex-wrap text-center flex-col md:flex-row space-y-12 md:space-y-0 pb-12 lg:pb-28 justify-center space-x-20 md:space-x-48 px-14">
